...
@Data
public class CustomerResp extends DmHubErrorResp implements Serializable {
    /** 序列号 */
    ...
    /** 如果name不为空，等于name的值，否则等于nickName的值，只读字段；批量更新传该字段，会导致其他字段也更新失败 */
    ...
    /** 创建时间 根据客户创建时间查询客户，格式为:"2017-06-01T12:12:12Z"，为UTC时间 */
