 ...
 */
@Data
public class BaseUdoReq<T extends BaseUdoRowReq> {
    ...
    public BaseUdoReq(String objectId, List<T> data) {
        this.objectId = objectId;
        this.data = data;
    }

    public BaseUdoReq(String objectId, List<T> data, Integer version) {
        this.objectId = objectId;
